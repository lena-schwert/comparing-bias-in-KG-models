...
def set_base_path_based_on_host():
    ...
    """
    if socket.gethostname() == 'powerhorse':
...
class HumanWikidata5M_pykeen(PathDataset):
    ...
    def __init__(self, base_path_host: str, rel_training_set_path: str,
        ...
        self.location_of_mapping_files = os.path.join(self.base_path_host,
                                                      'data/processed/files_per_model/KG_only_KGE')
        ...
        logging.debug('Dataset is in the process of being created.')
        ...
        logging.debug('HumanWikidata5M passed all assertions.')
    ...
    def _load(self) -> None:
        ...
        with open(os.path.join(self.location_of_mapping_files, 'entity_ID_to_numID_to_label_11052022_v1.tsv'), 'r') as f1:
