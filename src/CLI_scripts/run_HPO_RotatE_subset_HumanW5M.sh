...
#SBATCH -e /hpi/fs00/scratch/lena.schwertmann/pycharm_master_thesis/results/KG_only/HPO/slurm-%j_RotatE.txt
#SBATCH -o /hpi/fs00/scratch/lena.schwertmann/pycharm_master_thesis/results/KG_only/HPO/slurm-%j_RotatE.txt
