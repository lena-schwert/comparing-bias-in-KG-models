...
EXPERIMENT_NAME="05.01.2023_11:58_wiki5m_trans_SimKGC_IBSNPB_2xAIISGPUs_mascul_fem_descr"
...
--rerank-n-hop 2 \
--valid-path "${TEST_PATH}" "$@" | tee ${DIR}/${RESULT_FOLDER}/${EXPERIMENT_NAME}/log_evaluate_valset_${EXPERIMENT_NAME}_${START_TIME}.txt
