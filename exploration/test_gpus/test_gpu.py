...
print(f'Started Experiment at: {datetime.now().strftime("%d_%m_%Y_%H:%M")}')
...
for epoch in range(1, 11):
    ...
    print("Epoch:", epoch, "Training Loss: ", np.mean(train_loss), "Valid Loss: ",
          np.mean(valid_loss))


print(f'Finished Experiment at: {datetime.now().strftime("%d_%m_%Y_%H:%M")}')
